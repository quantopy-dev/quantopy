...
def prices(initial_price, mu, sigma, size=None, method="basic"):
    """Generate price evolution from a given method.
    ...
    .. [1] "Normal distribution", *Wikipedia*, https://en.wikipedia.org/wiki/Normal_distribution.
    """
    simulated_returns = returns(mu, sigma, size=None, method="basic")
    ...
    simulated_prices = initial_price * simulated_returns.cumprod()
